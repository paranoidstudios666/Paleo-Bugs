package net.mcreator.paleobugs.world.features;
...
import net.mcreator.paleobugs.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, PaleobugsMod.MODID);
