...
public class Modelarana<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "arana"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone7 = partdefinition.addOrReplaceChild("bone7", CubeListBuilder.create().texOffs(0, 7)
				.addBox(-2.0F, -3.0F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(1, 16).mirror()
				.addBox(-2.0F, -2.75F, -1.75F, 4.0F, 3.0F, 0.0F, new CubeDeformation(0.5F)).mirror(false),
				PartPose.offset(0.0F, 23.0F, -1.0F));

		PartDefinition bone6 = bone7.addOrReplaceChild("bone6", CubeListBuilder.create(),
				PartPose.offsetAndRotation(2.0F, -1.0F, 1.0F, 0.0F, -0.1745F, 0.0F));

		PartDefinition cube_r1 = bone6.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -4.0F, 0.0F, 5.0F, 6.0F, 0.0F,
		...
		PartDefinition bone5 = bone7.addOrReplaceChild("bone5", CubeListBuilder.create(),
				PartPose.offsetAndRotation(2.0F, -1.0F, -1.0F, 0.0F, 0.8727F, 0.0F));
		...
		PartDefinition bone4 = bone7.addOrReplaceChild("bone4", CubeListBuilder.create(),
				PartPose.offsetAndRotation(2.0F, -1.0F, 0.0F, 0.0F, 0.4363F, 0.0F));
		...
		PartDefinition cube_r4 = bone2.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 0).mirror()
						.addBox(-5.0F, -4.0F, 0.0F, 5.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition bone3 = bone7.addOrReplaceChild("bone3", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-2.0F, -1.0F, 1.0F, 0.0F, 0.829F, 0.0F));
		...
		PartDefinition bone8 = bone7.addOrReplaceChild("bone8", CubeListBuilder.create().texOffs(0, 20).addBox(-2.5F,
				-3.5F, 0.0F, 5.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.0F, 2.0F));
